...
public sealed class LocalizationService
{
    ...
    private void LoadDefaults()
    {
        ...
        _strings["Conn.Manage"] = "Connection list…";
        _strings["Mtp.Devices.Title"] = "Devices";
        _strings["Mtp.Devices.Column"] = "Device";
        _strings["Mtp.Devices.Property"] = "Property";
        _strings["Mtp.Devices.Value"] = "Value";
        _strings["Mtp.Devices.None"] = "No devices attached";
        _strings["Mtp.Devices.Reading"] = "Reading properties…";
        _strings["Mtp.Devices.Unavailable"] = "The device is not responding";
        _strings["Mtp.OpenInPanel"] = "Open in panel";
        _strings["Mtp.Prop.Name"] = "Name";
        _strings["Mtp.Prop.Manufacturer"] = "Manufacturer";
        _strings["Mtp.Prop.Model"] = "Model";
        _strings["Mtp.Prop.Type"] = "Type";
        _strings["Mtp.Prop.Serial"] = "Serial number";
        _strings["Mtp.Prop.Firmware"] = "Firmware";
        _strings["Mtp.Prop.Protocol"] = "Protocol";
        _strings["Mtp.Prop.Transport"] = "Connection";
        _strings["Mtp.Prop.Power"] = "Power";
        _strings["Mtp.Prop.PowerValue"] = "{0}, {1}%";
        _strings["Mtp.Prop.InUse"] = "Open in a panel";
        _strings["Mtp.Prop.DeviceId"] = "Identifier";
        _strings["Mtp.Prop.StorageValue"] = "{0} free of {1}";
        ...
        _strings["Ctx.ShellMenu"] = "Windows menu…";
        _strings["Shell.MenuFailed"] = "The Windows system menu could not be shown.";
