...
partial class ConnectionsForm
{
    ...
    private ColumnHeader _colAddress = null!;
    private ColumnHeader _colAuto = null!;
    ...
    private void InitializeComponent()
    {
        ...
        _colAddress = new ColumnHeader();
        _colAuto = new ColumnHeader();
        ...
        _list.Columns.AddRange(new[] { _colName, _colAddress, _colAuto });
        ...
        // _colAddress
        //
        _colAddress.Text = "Address";
        _colAddress.Width = 320;
        //
        // _colAuto
        //
        _colAuto.Text = "Auto-connect";
        _colAuto.Width = 120;
        //
        // _buttonBar
        //
        ...
        _buttonBar.Size = new Size(660, 56);
        _uiMetadata.SetThemeRole(_buttonBar, ThemeRole.HeaderBackground);
        //
        // _leftGroup
        //
        // A FlowLayoutPanel rather than docking the three buttons straight into the panel: Margin is
        // ignored on a control docked into a Panel, and two Dock.Left siblings stack outward from the
        // last added - both traps this codebase has already been bitten by (see BookmarksForm).
        ...
        Text = "Connections";
        _uiMetadata.SetLocalizationKey(this, "Conn.Title");
