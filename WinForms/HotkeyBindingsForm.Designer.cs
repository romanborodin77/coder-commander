...
partial class HotkeyBindingsForm
{
    ...
    /// <summary>Layout only. Rows are built at runtime from the canonical default hotkey table;
    /// column captions are localized in the constructor since a <see cref="ColumnHeader"/> is not a
    ...
    private void InitializeComponent()
    {
        ...
        _hint.Name = "_hint";
        _hint.Size = new Size(480, 24);
        _hint.Text = "Double-click a row to set a new shortcut, or Escape to cancel.";
        _uiMetadata.SetLocalizationKey(_hint, "Settings.Hotkeys.Hint");
        ...
        _uiMetadata.SetLocalizationKey(_clearBtn, "Settings.Hotkeys.Clear");
        //
        // _resetBtn
        //
        ...
        _uiMetadata.SetLocalizationKey(_resetBtn, "Settings.Hotkeys.ResetAll");
        //
        // _bottomPanel
        //
        ...
        // Fill first, then the Top/Bottom edge-docked siblings - see the docking-order note in
        // DirectoryTreeForm.Designer.cs.
        Controls.Add(_list);
        Controls.Add(_hint);
        ...
        MaximizeBox = false;
        MinimizeBox = false;
        Name = "HotkeyBindingsForm";
        Text = "Application hotkeys";
        _uiMetadata.SetLocalizationKey(this, "Settings.Hotkeys.Title");
